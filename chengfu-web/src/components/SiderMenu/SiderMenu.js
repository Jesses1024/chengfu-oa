  ...
  getNavMenuItems = (menusData) => {
    ...
    return menusData
      ...
      .map((item) => {
        ...
        const hasChild = item.children && item.children
          .find(child => child.name &&
            (!child.authority || this.checkPermissionItem(child.authority, true, false)
            ));
        return hasChild ? ItemDom : this.checkPermissionItem(item.authority, ItemDom);
      });
  };
