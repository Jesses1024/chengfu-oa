...
@connect(({ shelfList, loading }) => ({
  shelfList,
  loading: loading.models.shelfList,
}))
@Form.create()
export default class Shelfist extends PureComponent {
  state = {
    expandForm: false,
    formValues: {},
  };
  ...
  render() {
    const { shelfList: { data }, loading } = this.props;

    const columns = [{
      title: '操作',
      render: item => (
        <HasPermission perms={['inventory:shelf:edit']} noMatch="-">
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <HasPermission perms={['inventory:shelf:edit']}>
